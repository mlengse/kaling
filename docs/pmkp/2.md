...
1. Tersedia bukti identifikasi pasien sebelum intervensi kepada pasien sesuai dengan kebijakan dan prosedur yang ditetapkan.  
   ...
   5. 📥 **Unduh Template:** [SPO Identifikasi Pasien & Catatan Komunikasi (Word)](/templates/spo-identifikasi-komunikasi-efektif.doc)
   :::
1. Tersedia bukti pelaksanaan komunikasi efektif yang didokumentasikan di rekam medik pasien. 
   ...
   5. 📥 **Unduh Template:** [SPO Komunikasi Efektif SBAR & TBAK (Word)](/templates/spo-identifikasi-komunikasi-efektif.doc)
   :::
2. Tersedia bukti pengelolaan keamanan obat resiko tinggi. 
   ...
   :::
1. Penandaan sisi operasi/tindakan medis secara konsisten oleh pemberi pelayanan yang akan melakukan tindakan sesuai kebijakan dan prosedur yang ditetapkan yang didokumentasikan di rekam medik pasien ⚠️ **[Bisa TDD](/pendahuluan/tdd#pmkp-2-ep-4)**.
   :::tip Kelengkapan Bukti
   ...
   4. 📥 **Unduh Template:** [SPO Bedah Minor & WHO Surgical Safety Checklist (Word)](/templates/surgical-safety-checklist.doc)
   :::
2. Tersedia bukti pelaksanaan *Surgical Safety Checklist* yang didokumentasikan di rekam medis pasien ⚠️ **[Bisa TDD](/pendahuluan/tdd#pmkp-2-ep-5)**.
   :::tip Kelengkapan Bukti
    1. Terdapat dokumen bukti pelaksanaan *Surgical Safety Checklist* pada rekam medis pasien. 
    2. Melaksanakan wawancara terkait pelaksanaan *Surgical Safety Checklist*  
    3. 📥 **Unduh Template:** [SPO Bedah Minor & WHO Surgical Safety Checklist (Word)](/templates/surgical-safety-checklist.doc)
   :::
