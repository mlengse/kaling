...
2. Tersedia bukti pengelolaan keamanan obat resiko tinggi. 
   ...
   :::
1. Penandaan sisi operasi/tindakan medis secara konsisten oleh pemberi pelayanan yang akan melakukan tindakan sesuai kebijakan dan prosedur yang ditetapkan yang didokumentasikan di rekam medik pasien ⚠️ **[Bisa TDD](/pendahuluan/tdd)**.
   :::tip Kelengkapan Bukti
   ...
   :::
2. Tersedia bukti pelaksanaan *Surgical Safety Checklist* yang didokumentasikan di rekam medis pasien ⚠️ **[Bisa TDD](/pendahuluan/tdd)**.
   :::tip Kelengkapan Bukti
