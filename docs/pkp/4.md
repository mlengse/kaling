...
2. Kajian awal sekurang kurangnya memuat data angka `1.` sampai angka `5.`  
   ...
   ::: 
3. Kajian ulang dibuat dalam bentuk CPPT dan terdokumentasi di rekam medik ⚠️ **[Bisa TDD](/pendahuluan/tdd#pkp-4-ep-3)**.
   :::tip Kelengkapan Bukti
   * Terdapat bukti pengkajian ulang yang dibuat dalam bentuk CPPT dan terdokumentasi di Rekam Medik. 
   * 📥 **Unduh Template:** [Formulir Catatan Perkembangan Pasien Terintegrasi / CPPT (Word)](/templates/form-cppt.doc)
   ::: 
