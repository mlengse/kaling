...
## Elemen Penilain  
1. Ada penetapan jenis-jenis pelayanan laboratorium yang disediakan ⚠️ **[Bisa TDD](/pendahuluan/tdd#pkp-13-ep-1)**.
   ...
   ::: 
2. Terdapat Penanggung Jawab Laboratorium sesuai perundang-undangan yang berlaku ⚠️ **[Bisa TDD](/pendahuluan/tdd#pkp-13-ep-2)**.
   :::tip Kelengkapan Bukti
   ...
   ::: 
3. Klinik menetapkan rentang nilai normal untuk setiap jenis pemeriksaan yang disediakan ⚠️ **[Bisa TDD](/pendahuluan/tdd#pkp-13-ep-3)**.
   :::tip Kelengkapan Bukti
   ...
   ::: 
4. Ada bukti reagensia esensial dan bahan lain tersedia sesuai dengan jenis pelayanan yang ditetapkan, pelabelan dan penyimpanannya ⚠️ **[Bisa TDD](/pendahuluan/tdd#pkp-13-ep-4)**.
   :::tip Kelengkapan Bukti
   ...
   ::: 
5. Ada prosedur pelaporan, pencatatan dan tindak lanjut hasil laboratorium kritis ⚠️ **[Bisa TDD](/pendahuluan/tdd#pkp-13-ep-5)**.
   :::tip Kelengkapan Bukti
...
6. Ada prosedur rujukan spesimen dan/ atau pengguna layanan, jika pemeriksaan laboratorium tidak dapat dilakukan oleh klinik. 
   ...
   ::: 
7. Ada bukti pelaksanaan Pemantapan Mutu Internal (PMI) dan Pemantapan Mutu Eksternal  (PME) secara berkala ⚠️ **[Bisa TDD](/pendahuluan/tdd#pkp-13-ep-7)**.
   :::tip Kelengkapan Bukti
