...
## Elemen Penilaian 
1. Klinik menetapkan prosedur pelayanan anestesi dan bedah sesuai kebutuhan ⚠️ **[Bisa TDD](/pendahuluan/tdd#pkp-8-ep-1)**.
   ...
   * 📥 **Unduh Template:** [SPO Anestesi Lokal & Bedah Minor (Word)](/templates/spo-anestesi-bedah-minor.doc)
   ::: 
2. Pelayanan anestesi dan bedah dilakukan oleh tenaga medis yang kompeten sesuai dengan ketentuan peraturan perundang-undangan ⚠️ **[Bisa TDD](/pendahuluan/tdd#pkp-8-ep-2)**.
   :::tip Kelengkapan Bukti
   ...
   ::: 
3. Jenis, dosis dan teknik anestesi dan pemantauan status fisiologi pasien selama pemberian anestesi oleh petugas dicatat dalam rekam medis pasien ⚠️ **[Bisa TDD](/pendahuluan/tdd#pkp-8-ep-3)**.
   :::tip Kelengkapan Bukti
   ...
   ::: 
4. Ada bukti pelaksanaan kajian pra bedah ⚠️ **[Bisa TDD](/pendahuluan/tdd#pkp-8-ep-4)**.
   :::tip Kelengkapan Bukti
   ...
   ::: 
5. Ada bukti pelaksanaan kajian pra anestesi ⚠️ **[Bisa TDD](/pendahuluan/tdd#pkp-8-ep-5)**.
   :::tip Kelengkapan Bukti
   ...
   ::: 
6. Ada bukti pemantauan dan evaluasi paska anestesi dan bedah ⚠️ **[Bisa TDD](/pendahuluan/tdd#pkp-8-ep-6)**.
   :::tip Kelengkapan Bukti
